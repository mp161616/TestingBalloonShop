...
public class OrderServiceImpl implements OrderService {
    ...
    @Override
    @Transactional
    public Order placeOrder(String username, String deliveryAddress, List<Balloon> balloons, LocalDateTime date) {
        ...
        Order order = new Order(user, deliveryAddress, date);
